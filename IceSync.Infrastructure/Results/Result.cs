...
namespace IceSync.Infrastructure.Results
{
    ...
    public static class Result
    {
        ...
        /// <summary>Convert entity result to model result.</summary>
        /// <typeparam name="TModel">The model object.</typeparam>
        public static Result<TModel> AttachMetadata<TModel>(this Result<TModel> entity, IResultMetadata metadata) =>
            new (entity.Data, entity.Status, entity.Messages, metadata);
        ...
        /// <typeparam name="TEntity">The entity object.</typeparam>
        /// <typeparam name="TModel">The model object.</typeparam>
        public static Result<IList<TModel>> MapList<TEntity, TModel>(this Result<IList<TEntity>> entity, Func<TEntity, TModel> converter) =>
            entity.Map(it => (IList<TModel>)it.Select(converter).ToList());
